...
import User from '../assets/getlaps-user.png'
import Admin from '../assets/getlaps-admin.png'
import Portfolio from '../assets/portfolio.png'
import Netflix from '../assets/netflix-clone.png'
import OLX from '../assets/olx-clone.png'
...
{/* Container */}
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100'>
              ...
              <div className='pt-8 text-center'>
                <a href='https://getlaps.club/' target='_blank'>
          ...
          <div
            style={{ backgroundImage: `url(${Incubation})` }}
            className='shadow-lg shadow-pink-600 group container rounded-md flex justify-center items-center mx-auto content-div'
          >
            {/* Hover Effects */}
            <div className='opacity-0 group-hover:opacity-100'>
